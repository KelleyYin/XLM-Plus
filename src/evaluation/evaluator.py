            ...
            for data_set in ['valid', 'test']:
                ...
                for (sent1, len1), (sent2, len2) in self.get_iterator(data_set, lang1, lang2):
                    if params.share_word_embeddings or params.share_all_embeddings:
                        ...
                        lang1_txt.extend(convert_to_text(sent1, len1, self.dico[lang1], params))
                        lang2_txt.extend(convert_to_text(sent2, len2, self.dico[lang2], params))
        ...
        for batch in self.get_iterator(data_set, lang1, lang2):
            ...
            if eval_bleu:
                ...
                if params.share_word_embeddings or params.share_all_embeddings:
                    ...
                    hypothesis.extend(convert_to_text(generated, lengths, self.dico[dec_lang], params))

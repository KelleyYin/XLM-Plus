...
class Trainer(object):
    ...
    def __init__(self, data, params):
        ...
        if params.share_word_embeddings or params.share_all_embeddings:
            ...
            counts = np.array(list(self.data['dico'][tgt_lang].counts.values()))
    ...
    def save_checkpoint(self, name, include_optimizers=True):
        ...
        if self.params.share_word_embeddings or self.params.share_all_embeddings:
            ...
            for lang, v in self.data['dico'].items():
                if lang not in data:
                    data[lang] = {}
                data[lang]['dico_id2word'] = self.data['dico'][lang].id2word
                data[lang]['dico_word2id'] = self.data['dico'][lang].word2id
                data[lang]['dico_counts'] = self.data['dico'][lang].counts
